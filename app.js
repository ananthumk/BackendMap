...
app.get('/api/map', authenicateUser, async(req, res) => {
    return res.status(200).json({message: 'Map Data',  location:[
       {
         location_coordinates: {lat: 28.6139, lng: 77.2090 }, place_coordinates: {lat: 28.5970, lng: 77.0366} , address: 'Dwarka, New Delhi'
       },
       {
        location_coordinates: {lat: 19.0760, lng: 72.8777 }, place_coordinates: {lat: 19.1197, lng: 72.8464} , address: 'Andheri, Mumbai'
       },
       {
        location_coordinates: {lat: 17.3850, lng: 78.4867 }, place_coordinates: {lat: 17.4401, lng: 78.3489} , address: 'Gachibowli, Hyderbad'
       },
       {
        location_coordinates: {lat: 12.9716, lng: 77.5946 }, place_coordinates: {lat: 12.9698, lng: 77.7500} , address: 'WhiteField, bengaluru'
       },
    ] })
})
